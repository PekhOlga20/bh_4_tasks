...
def split_to_parts(str_to_split: str) -> tuple:
    ...
    if len(str_to_split) % 2 != 0:
        part_1 = str_to_split[:len(str_to_split) // 2 +1]
        part_2 = str_to_split[len(str_to_split) // 2 +1:]
    else:
        part_1 = str_to_split[:len(str_to_split) // 2]
        part_2 = str_to_split[len(str_to_split) // 2:]
